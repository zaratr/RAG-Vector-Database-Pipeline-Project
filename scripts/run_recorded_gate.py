...
PRIMARY_STEPS["phase10d"] = [
    ...
    {"kind": "subprocess", "argv": ["docker", "compose", "exec", "-T", "api",
     "python", "scripts/validate_named_volume_durability.py",
     "--output", "/tmp/phase10d-durability.json"],
     "description": "named-volume durability validation (in-container stores)"},
    {"kind": "subprocess", "argv": ["docker", "compose", "cp",
     "api:/tmp/phase10d-durability.json",
     ".hermes/reports/phase10d-durability.json"],
     "description": "copy durability record to reports"},
    {"kind": "subprocess", "argv": ["docker", "compose", "exec", "-T", "api", "python",
     "scripts/fingerprint_production_state.py", "--json"],
